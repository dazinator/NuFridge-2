...
using NuFridge.Shared.Web.Nancy;
using NuFridge.Shared.Web.RouteResolvers;
...
namespace NuFridge.Shared.Web
{
    public class WebBootstrapper : AutofacNancyBootstrapper, IPortalBootstrapper
    {
        ...
        protected override void ApplicationStartup(ILifetimeScope applicationContainer, IPipelines pipelines)
        {
            ...
            this.EnableLightningCache(applicationContainer.Resolve<IRouteResolver>(), pipelines, new MemoryCacheKeyGenerator(), new MemoryCacheStore());
        }
