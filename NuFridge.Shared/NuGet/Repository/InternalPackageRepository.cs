...
namespace NuFridge.Shared.NuGet.Repository
{
    public class InternalPackageRepository : LocalPackageRepository, IInternalPackageRepository
    {
        ...
        private readonly InternalPackageIndex _internalPackageIndex;
        ...
        {
            return _internalPackageIndex.GetPackage(packageId, version);
        }

        public void IncrementDownloadCount(IInternalPackage package, string ipAddress, string userAgent)
        {
            _internalPackageIndex.IncrementDownloadCount(package, ipAddress, userAgent);
        }
        ...
        public void DeletePackage(IInternalPackage internalPackage)
        {
            ...
            //Delete the package
            _internalPackageIndex.DeletePackage(internalPackage);
            ...
            {
                IPackage package = FastZipPackage.Open(filePath, new CryptoHashProvider());
        ...
        {
            _internalPackageIndex.UnlistPackage(internalPackage);
        }
