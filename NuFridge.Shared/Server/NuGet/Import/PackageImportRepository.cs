...
namespace NuFridge.Shared.Server.NuGet.Import
{
    public class PackageImportRepository : IPackageImportRepository
    {
        ...
        public IEnumerable<PackageImportResult> GetPackages(PackageImportOptions options)
        {
            bool firstRun = true;
        ...
        private IEnumerable<ODataPackage> QueryFeed(PackageImportOptions options, int top, int skip, out long count)
        {
    ...
    {
        IEnumerable<PackageImportRepository.PackageImportResult> GetPackages(PackageImportOptions options);
    }
}