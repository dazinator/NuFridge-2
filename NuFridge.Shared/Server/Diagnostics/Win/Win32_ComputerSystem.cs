...
namespace NuFridge.Shared.Server.Diagnostics.Win {
    ...
    public class Win32ComputerSystem : Component {
        
        // Private property to hold the WMI namespace in which the class resides.
        private static string _createdWmiNamespace = "root\\cimv2";
        
        // Private property to hold the name of WMI class which created this class.
        private static string _createdClassName = "Win32_ComputerSystem";
        ...
        public Win32ComputerSystem(string keyName) {
            InitializeObject(null, new ManagementPath(ConstructPath(keyName)), null);
        }
        
        public Win32ComputerSystem(ManagementScope mgmtScope, string keyName) {
            InitializeObject(mgmtScope, new ManagementPath(ConstructPath(keyName)), null);
        }
        
        public Win32ComputerSystem(ManagementPath path, ObjectGetOptions getOptions) {
            InitializeObject(null, path, getOptions);
        }
        
        public Win32ComputerSystem(ManagementScope mgmtScope, ManagementPath path) {
            InitializeObject(mgmtScope, path, null);
        }
        
        public Win32ComputerSystem(ManagementPath path) {
            InitializeObject(null, path, null);
        }
        
        public Win32ComputerSystem(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) {
            InitializeObject(mgmtScope, path, getOptions);
        }
        
        public Win32ComputerSystem(ManagementObject theObject) {
            Initialize();
        ...
        public Win32ComputerSystem(ManagementBaseObject theObject) {
            Initialize();
            if (CheckIfProperClass(theObject)) {
 ...
 Note that the CIM_ComputerSystem Name calculated using the heuristic is the system's key value. Other names can be assigned and used for the CIM_ComputerSystem that better suit the business, using Aliases.")]
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsPcSystemTypeExNull {
            get
            {
                if ((_curObj["PCSystemTypeEx"] == null)) {
                    return true;
                }
                return false;
            }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [TypeConverter(typeof(WmiValueTypeConverter))]
        public PcSystemTypeExValues PcSystemTypeEx {
            get {
                if ((_curObj["PCSystemTypeEx"] == null)) {
                    return ((PcSystemTypeExValues)(Convert.ToInt32(10)));
                }
                return ((PcSystemTypeExValues)(Convert.ToInt32(_curObj["PCSystemTypeEx"])));
            }
        }
        ...
        public PowerManagementCapabilitiesValues[] PowerManagementCapabilities {
            get {
                Array arrEnumVals = ((Array)(_curObj["PowerManagementCapabilities"]));
...
Note:  The SE_SYSTEM_ENVIRONMENT privilege is required on IA64bit machines. This privilege is not required for 32bit systems.")]
        ...
        private bool ShouldSerializePcSystemType() {
            if ((IsPcSystemTypeNull == false)) {
                return true;
            }
            return false;
        }
        
        private bool ShouldSerializePcSystemTypeEx() {
            if ((IsPcSystemTypeExNull == false)) {
                return true;
            }
            return false;
        }
        ...
        public static ComputerSystemCollection GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            ...
            ManagementObjectSearcher objectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_ComputerSystem", condition, selectedProperties));
        ...
        [Browsable(true)]
        public static Win32ComputerSystem CreateInstance() {
            ManagementScope mgmtScope = null;
            if ((_statMgmtScope == null)) {
                mgmtScope = new ManagementScope {Path = {NamespacePath = _createdWmiNamespace}};
            }
            else {
                mgmtScope = _statMgmtScope;
            }
            ...
            return new Win32ComputerSystem(tmpMgmtClass.CreateInstance());
        }
        ...
        public uint JoinDomainOrWorkgroup(string accountOu, uint fJoinOptions, string name, string password, string userName)
        {
            if ((_isEmbedded == false)) {
                ...
                inParams = _privateLateBoundObject.GetMethodParameters("JoinDomainOrWorkgroup");
                inParams["AccountOU"] = accountOu;
                inParams["FJoinOptions"] = fJoinOptions;
                inParams["Name"] = name;
                inParams["Password"] = password;
                inParams["UserName"] = userName;
                ManagementBaseObject outParams = _privateLateBoundObject.InvokeMethod("JoinDomainOrWorkgroup", inParams, null);
        ...
        public uint Rename(string name, string password, string userName)
        {
            if ((_isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = _privateLateBoundObject.GetMethodParameters("Rename");
                inParams["Name"] = name;
                inParams["Password"] = password;
                inParams["UserName"] = userName;
                ManagementBaseObject outParams = _privateLateBoundObject.InvokeMethod("Rename", inParams, null);
                return Convert.ToUInt32(outParams.Properties["ReturnValue"].Value);
            }
            return Convert.ToUInt32(0);
        }
        ...
        public uint SetPowerState(ushort powerState, DateTime time)
        {
            if ((_isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = _privateLateBoundObject.GetMethodParameters("SetPowerState");
                inParams["PowerState"] = powerState;
                inParams["Time"] = ToDmtfDateTime(time);
                ManagementBaseObject outParams = _privateLateBoundObject.InvokeMethod("SetPowerState", inParams, null);
                return Convert.ToUInt32(outParams.Properties["ReturnValue"].Value);
            }
            return Convert.ToUInt32(0);
        }
        ...
        public uint UnjoinDomainOrWorkgroup(uint fUnjoinOptions, string password, string userName)
        {
            if ((_isEmbedded == false)) {
                ManagementBaseObject inParams = null;
                inParams = _privateLateBoundObject.GetMethodParameters("UnjoinDomainOrWorkgroup");
                inParams["FUnjoinOptions"] = fUnjoinOptions;
                inParams["Password"] = password;
                inParams["UserName"] = userName;
                ManagementBaseObject outParams = _privateLateBoundObject.InvokeMethod("UnjoinDomainOrWorkgroup", inParams, null);
                return Convert.ToUInt32(outParams.Properties["ReturnValue"].Value);
            }
            return Convert.ToUInt32(0);
        }
        ...
        public enum PcSystemTypeExValues {
        ...
        public class ComputerSystemCollection : object, ICollection {
            ...
            public virtual void CopyTo(Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new Win32ComputerSystem(((ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class ComputerSystemEnumerator : object, IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new Win32ComputerSystem(((ManagementObject)(_privObjEnum.Current)));
                    }
                }
