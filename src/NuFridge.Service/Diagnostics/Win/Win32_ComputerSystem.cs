...
namespace NuFridge.Service.Diagnostics.Win {
    ...
    public class Win32_ComputerSystem : System.ComponentModel.Component {
        ...
        public Win32_ComputerSystem(string keyName) {
            this.InitializeObject(null, new System.Management.ManagementPath(Win32_ComputerSystem.ConstructPath(keyName)), null);
        }
        
        public Win32_ComputerSystem(System.Management.ManagementScope mgmtScope, string keyName) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(Win32_ComputerSystem.ConstructPath(keyName)), null);
        }
        
        public Win32_ComputerSystem(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public Win32_ComputerSystem(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public Win32_ComputerSystem(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public Win32_ComputerSystem(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public Win32_ComputerSystem(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public Win32_ComputerSystem(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        public bool IsHypervisorPresentNull {
            get {
                if ((curObj["HypervisorPresent"] == null)) {
                    return true;
                }
                else {
                    return false;
        ...
        public bool HypervisorPresent {
            get {
                ...
                return ((bool)(curObj["HypervisorPresent"]));
            }
        }
 ...
 Note that the CIM_ComputerSystem Name calculated using the heuristic is the system's key value. Other names can be assigned and used for the CIM_ComputerSystem that better suit the business, using Aliases.")]
        ...
        public PCSystemTypeExValues PCSystemTypeEx {
            get {
                if ((curObj["PCSystemTypeEx"] == null)) {
                    return ((PCSystemTypeExValues)(System.Convert.ToInt32(10)));
                }
                return ((PCSystemTypeExValues)(System.Convert.ToInt32(curObj["PCSystemTypeEx"])));
            }
        }
...
Note:  The SE_SYSTEM_ENVIRONMENT privilege is required on IA64bit machines. This privilege is not required for 32bit systems.")]
        ...
        private bool ShouldSerializeHypervisorPresent() {
            if ((this.IsHypervisorPresentNull == false)) {
                return true;
            }
            return false;
        }
        ...
        private bool ShouldSerializePCSystemTypeEx() {
            if ((this.IsPCSystemTypeExNull == false)) {
                return true;
            }
            return false;
        }
        ...
        [Browsable(true)]
        public static Win32_ComputerSystem CreateInstance() {
            ...
            return new Win32_ComputerSystem(tmpMgmtClass.CreateInstance());
        }
        ...
        public uint JoinDomainOrWorkgroup(string AccountOU, uint FJoinOptions, string Name, string Password, string UserName) {
            if ((isEmbedded == false)) {
                ...
                inParams["AccountOU"] = ((string)(AccountOU));
                inParams["FJoinOptions"] = ((uint)(FJoinOptions));
                inParams["Name"] = ((string)(Name));
                inParams["Password"] = ((string)(Password));
                inParams["UserName"] = ((string)(UserName));
        ...
        public uint UnjoinDomainOrWorkgroup(uint FUnjoinOptions, string Password, string UserName) {
            if ((isEmbedded == false)) {
                ...
                inParams["FUnjoinOptions"] = ((uint)(FUnjoinOptions));
                inParams["Password"] = ((string)(Password));
                inParams["UserName"] = ((string)(UserName));
        ...
        public class ComputerSystemCollection : object, ICollection {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new Win32_ComputerSystem(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class ComputerSystemEnumerator : object, System.Collections.IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new Win32_ComputerSystem(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
