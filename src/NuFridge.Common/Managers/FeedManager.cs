    ...
    public class FeedManager
    {
        ...
        public IEnumerable<Feed> GetAll()
        {
            ...
            foreach (var feed in feeds)
            {
                ...
                feed.FeedURL = string.Format("{0}{1}{2}", website.Bindings[0].Url, ConfigurationManager.AppSettings["IIS.FeedWebsite.IISPath"], feed.Name);
            }
        ...
        {
            appPath = string.Format("{0}{1}", ConfigurationManager.AppSettings["IIS.FeedWebsite.IISPath"], feedName);
        ...
        public bool CreateFeed(NuFridge.DataAccess.Model.Feed feed, out string message)
        {
            ...
            var feedRootFolder = ConfigurationManager.AppSettings["IIS.FeedWebsite.RootDirectory"];
